...
export class News extends Component {
    ...
    componentDidMount(){
        ...
        let url = "https://newsapi.org/v2/top/-headlines?country=in&apiKey=4ed330cbd0974333a944910a0fa0ea4d";
    }   
  render() {
    ...
    return (
      ...
      <div className="container my-2">
        ...
        {this.state.articles.map((element)=>{
            ...
            <NewsItem  title={element.title.slice(0,45)} description={element.description} urlImage={element.urlToImage} newsUrl={element.url} />
        </div>
        })}
