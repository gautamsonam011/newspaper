  ...
  render() {
    ...
    return (
      ...
      <div className='container d-flex justify-content-between'>
        <button type="button" className="btn btn-sm btn-primary" onClick={handlePrevClick}>&larr; Previous</button>
        <button type="button" className="btn btn-sm btn-primary" onClick={handleNextClick}> Next &rarr;</button>
      </div>
      </>
    )
  }
