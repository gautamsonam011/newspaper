...
export class News extends Component {
  static defaultProps = {
    ...
    async updateNews(pageNo){
      const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=4ed330cbd0974333a944910a0fa0ea4d&page-1&pageSize-${this.props.pageSize}`;
